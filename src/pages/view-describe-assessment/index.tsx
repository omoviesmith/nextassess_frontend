    ...
    <div className="bg-cover">
      <div className="w-full lg:w-10/12 mx-auto px-4 py-4">
        <div className="flex flex-wrap gap-10 justify-between items-center">
          <div className="bg-white flex flex-wrap px-6 py-3 gap-2 rounded-md">
            <span>
              ...
              >
                <g clip-path="url(#clip0_191_1758)">
                  <path
                    d="M12.3384 3L4.33838 9V21H9.33838V14H15.3384V21H20.3384V9L12.3384 3Z"
                    fill="#323232"
                  />
                </g>
                <defs>
            ...
            <span>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_191_1761)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_191_1761">
                    <rect width="24" height="24" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </span>
            <span className="font-raleway">Upload Assessment</span>
            <span>
              <svg
                width="24"
                height="24"
          ...
          <button className="py-3 px-6 bg-white flex gap-2 rounded-md">
            <span>
              <svg
                width="24"
                height="24"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_299_1550)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_299_1550">
                    <rect width="24" height="24" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </span>
            <span className="font-raleway">Edit</span>
          </button>
        </div>

        <div className="flex justify-center items-baseline flex-wrap mt-5">
          <div className="w-full lg:w-7/12 p-2">
            <div className="flex items-center flex-wrap lg:flex-nowrap mt-5 bg-white rounded-lg border border-gray-400">
              <div className="w-full xl:w-8/12 ">
                <img src="Rectangle 29.png" className="w-full" />
              </div>

              <div className="pr-16 pl-10 w-full">
                <p className="pt-4 text-2xl lg:text-4xl font-poppins font-semibold">
                  Historical Tale: A Tale of Two Cities
                </p>
                <p className="font-raleway my-5 text-gray-600 ">
                  In the midst of the turbulent period of the French Revolution,
                  Charles Dickens weaves a mesmerizing tale of love, sacrifice,
                  and redemption in "A Tale of Two Cities". The novel unfolds
                  against the backdrop of unrest and social upheaval, with vivid
                  descriptions of London and Paris during the late 18th century.
                </p>
                <div className="flex pb-2 items-center flex-wrap gap-4">
          ...
          <div className="w-full lg:w-7/12 p-2">
            <div className="flex flex-col items-center flex-wrap lg:flex-nowrap mt-5 bg-white rounded-lg border border-gray-400">
              <img src="Rectangle 29 (2).png" className="w-full" />
              <div className="pr-16 pl-10 w-full">
                <p className="pt-4 text-2xl lg:text-4xl font-poppins font-semibold text-center">
                  Historical Tale: A Tale of Two Cities
                </p>
                <p className="text-center font-raleway my-5 text-gray-600 ">
                  In the midst of the turbulent period of the French Revolution,
                  Charles Dickens weaves a mesmerizing tale of love, sacrifice,
                  and redemption in "A Tale of Two Cities". The novel unfolds
                  against the backdrop of unrest and social upheaval, with vivid
          ...
          <div className="w-full lg:w-7/12 p-2">
            <div className="flex flex-col items-center flex-wrap lg:flex-nowrap mt-5 bg-white rounded-lg border border-gray-400">
              <img src="Rectangle 29 (2).png" className="w-full" />
              <div className="pr-16 pl-10 w-full">
                <p className="pt-4 text-2xl lg:text-4xl font-poppins font-semibold text-left">
                  The Shoemaker’s Garret
                </p>
                <div className="flex flex-col pr-20 mt-5">
                  <div className="flex items-baseline gap-5">
                    <div>
                      <div className="h-14 w-14 bg-[#DADBF1] rounded-full text-center  flex justify-center items-center text-2xl">
                        <p>1</p>
                      </div>
                    </div>
                    <div>
                      <p className="text-2xl">The Shoemaker’s Garret</p>
                      <p className="font-raleway my-5 text-gray-600 ">
                        The shoemaker toils silently in his garret, immersed in
                        the solitude of his relentless work. His faded
                        surroundings bear testimony to a life of seclusion and
                        resilience.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-baseline gap-5">
                    ...
                    <div>
                      <p className="text-2xl">A Glimmer of Light</p>
                      <p className="font-raleway my-5 text-gray-600 ">
                        A ray of light pierces through the darkness, bringing a
                        momentary respite to the gloom that envelops the
                        shoemaker's garret. It illuminates the worn tools and
                        scraps of leather, casting a poignant glow on his
                  ...
                  <div className="flex items-baseline gap-5">
                    ...
                    <div>
                      <p className="text-2xl">Moment of Recognition</p>
                      <p className="font-raleway my-5 text-gray-600 ">
                        The shoemaker toils silently in his garret, immersed in
                        the solitude of his relentless work. His faded
                        surroundings bear testimony to a life of seclusion and
          ...
          <div className="w-full lg:w-7/12 p-2">
            <div className="flex flex-col items-center flex-wrap lg:flex-nowrap mt-5 bg-white rounded-lg border border-gray-400">
              ...
              <div className="px-6 w-full">
                <p className="pt-4 text-2xl lg:text-4xl font-poppins font-semibold text-left">
                  The Mystery of the Unfinished Shoe
                </p>
                <div className="flex my-5  gap-5">
                  <div className="bg-[#DADBF1] p-4 rounded-lg shadow-sm w-5/12">
                    <p className="text-2xl font-semibold">
                      A Glimpse of Recognition
                    </p>
                    <p className="text-[#666666] font-raleway mt-5">
                      As the visitor seeks to unlock the mystery of the shoe,
                      the shoemaker{} s hesitant responses provide a glimpse
                      into the enigma of his past, shrouded in layers of
                      solitude and longing.As the visitor seeks to unlock the
                      mystery of the shoe, the shoemaker{} s hesitant responses
                      provide a glimpse into the layers of solitude and longing.
                    </p>
                  </div>

                  <div className="flex flex-col gap-3 w-7/12">
                    <div className="bg-[#DADBF1] p-4 rounded-lg shadow-sm">
                      <p className="text-2xl font-poppins font-semibold">
                        Forgotten Artistry
                      </p>
                      <p className="text-[#666666] font-raleway mt-5">
                        The intricate details of the unfinished shoe bear
                        witness to the forgotten artistry of the shoemaker. Each
                        stitch and curve holds a story, waiting to be unraveled.
                      </p>
                    </div>

                    <div className="bg-[#DADBF1] p-4 rounded-lg shadow-sm">
                      <p className="text-2xl font-semibold">Lost Memory</p>
                      <p className="text-[#666666] font-raleway mt-5">
                        The shoemaker's struggle to recollect his craft mirrors
                        the fragments of forgotten memories that lay dormant
                        within him. The unfinished shoe becomes a poignant
                        symbol of his fractured past.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-between gap-4 mt-5">
              <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                <svg
                  width="30"
                  height="31"
                  viewBox="0 0 30 31"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_635_1434)">
                    <path
                      d="M3.17969 25.1636H5.61342C6.2827 25.1636 6.83029 24.616 6.83029 23.9468V12.995C6.83029 12.3257 6.2827 11.7781 5.61342 11.7781H3.17969V25.1636ZM27.3102 16.4995C27.444 16.1953 27.5171 15.8668 27.5171 15.526V14.2118C27.5171 12.8733 26.4219 11.7781 25.0833 11.7781H18.3905L19.5101 6.11965C19.5709 5.85194 19.5344 5.55989 19.4127 5.31652C19.1328 4.76893 18.7799 4.27001 18.3419 3.83194L17.7821 3.26001L9.98198 11.0601C9.51957 11.5225 9.26403 12.1431 9.26403 12.7881V22.3283C9.26403 23.8859 10.5417 25.1636 12.1115 25.1636H21.9803C22.8321 25.1636 23.6352 24.7134 24.0733 23.9833L27.3102 16.4995V16.4995Z"
                      fill="#323232"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_635_1434">
                      <rect
                        width="29.2048"
                        height="29.2048"
                        fill="white"
                        transform="translate(0.746094 0.826416)"
                      />
                    </clipPath>
                  </defs>
                </svg>
              ...
              <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_635_727)">
                    <path
                      d="M27.0039 5.69409H24.5701C23.9009 5.69409 23.3533 6.24168 23.3533 6.91096V17.8628C23.3533 18.5321 23.9009 19.0796 24.5701 19.0796H27.0039V5.69409ZM2.87337 14.3582C2.73952 14.6624 2.6665 14.991 2.6665 15.3317V16.6459C2.6665 17.9845 3.76169 19.0796 5.10024 19.0796H11.793L10.6735 24.7381C10.6127 25.0058 10.6492 25.2978 10.7708 25.5412C11.0507 26.0888 11.4036 26.5877 11.8417 27.0258L12.4014 27.5977L20.2016 19.7976C20.664 19.3352 20.9195 18.7146 20.9195 18.0696V8.54156C20.9195 6.9718 19.6418 5.69409 18.0721 5.69409H8.21542C7.35145 5.69409 6.56048 6.14433 6.12241 6.87445L2.87337 14.3582V14.3582Z"
                      fill="#323232"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_635_727">
                      <rect
                        width="29.2048"
                        height="29.2048"
                        fill="white"
                        transform="translate(0.23291 0.826416)"
                      />
                    </clipPath>
                  </defs>
                </svg>

                <p className="text-gray-500 text-sm">Unlike</p>
              </div>
              ...
              <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                ...
                >
                  <path
                    d="M17.1972 3.55373C15.4327 1.78927 13.0112 0.694092 10.3219 0.694092C4.94334 0.694092 0.599121 5.05048 0.599121 10.429C0.599121 15.8076 4.94334 20.164 10.3219 20.164C14.8608 20.164 18.6453 17.061 19.7283 12.8628H17.1972C16.1994 15.6981 13.4979 17.7302 10.3219 17.7302C6.29406 17.7302 3.02069 14.4569 3.02069 10.429C3.02069 6.4012 6.29406 3.12783 10.3219 3.12783C12.3419 3.12783 14.1429 3.96747 15.4571 5.29385L11.5388 9.21217H20.0568V0.694092L17.1972 3.55373Z"
                    fill="#FF0000"
                  />
                </svg>
              ...
              <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_635_1223)">
                    <path
                      d="M20.8936 4.47705H6.29116C4.94043 4.47705 3.85742 5.57223 3.85742 6.91079V23.9469C3.85742 25.2855 4.94043 26.3807 6.29116 26.3807H23.3273C24.6659 26.3807 25.761 25.2855 25.761 23.9469V9.34452L20.8936 4.47705ZM14.8092 23.9469C12.7892 23.9469 11.1586 22.3163 11.1586 20.2963C11.1586 18.2763 12.7892 16.6457 14.8092 16.6457C16.8292 16.6457 18.4598 18.2763 18.4598 20.2963C18.4598 22.3163 16.8292 23.9469 14.8092 23.9469ZM18.4598 11.7783H6.29116V6.91079H18.4598V11.7783Z"
                      fill="#323232"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_635_1223">
                      <rect
                        width="29.2048"
                        height="29.2048"
                        fill="white"
                        transform="translate(0.206543 0.826416)"
                      />
                    </clipPath>
                  </defs>
                </svg>

                <p className="text-gray-500 text-sm">Save</p>
              </div>
              ...
              <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                ...
                >
                  <g clip-path="url(#clip0_635_1372)">
                    <path
                      d="M23.3008 11.7783H18.4333V4.47705H11.1321V11.7783H6.26465L14.7827 20.2963L23.3008 11.7783ZM6.26465 22.7301V25.1638H23.3008V22.7301H6.26465Z"
                      fill="#323232"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0_635_1372">
                      <rect
                        ...
                        height="29.2048"
                        fill="white"
                        transform="translate(0.180176 0.826416)"
                      />
                    </clipPath>
                  </defs>
                </svg>
...
export default ViewDescribeAssessment;
