...
const Dashboard = () => {
  return (
    <>
      <div className="flex">
        <div className="w-[315px] h-screen bg-black px-4 py-8">
          <div className="flex items-center gap-2">
            <Image
              src="/AlphabetAvatarUser.png"
              alt="user avatar"
              width={24}
              height={24}
            />
            <p className="text-white font-poppins text-[15px]">Sooyaa</p>
          </div>
          <button
            className="w-full mt-5 p-3 rounded-md"
            style={{
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5">
                  ...
                  >
                    <path
                      d="M13.3337 1.66675H6.66699C3.33366 1.66675 1.66699 3.33341 1.66699 6.66675V17.5001C1.66699 17.9584 2.04199 18.3334 2.50033 18.3334H13.3337C16.667 18.3334 18.3337 16.6667 18.3337 13.3334V6.66675C18.3337 3.33341 16.667 1.66675 13.3337 1.66675Z"
                      stroke="white"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M7.08301 10H12.9163"
                      stroke="white"
                  ...
                  <p className="text-white">What is UX Design</p>
                </div>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5">
                  ...
                  <p className="text-white">Color Palettes</p>
                </div>
          ...
          <div className="mt-10">
            <div className="flex flex-col gap-5 absolute bottom-10 w-full">
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5 items-center">
                  ...
                  >
                    <path
                      d="M19 19.5H19.5V19V5V4.5H19H5H4.5V5V19V19.5H5H19ZM5 3.5H19C19.8239 3.5 20.5 4.17614 20.5 5V19C20.5 19.8239 19.8239 20.5 19 20.5H5C4.17614 20.5 3.5 19.8239 3.5 19V5C3.5 4.17614 4.17614 3.5 5 3.5ZM7.5 10.5H8.5V16.5H7.5V10.5ZM11.5 7.5H12.5V16.5H11.5V7.5ZM15.5 13.5H16.5V16.5H15.5V13.5Z"
                      fill="white"
                      stroke="white"
                    />
                  </svg>

                  <p className="text-white">AI-Generated Assess...</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5 items-center">
                  ...
                  >
                    <path
                      d="M20 20.9999V19.111C20 18.1091 19.5786 17.1482 18.8284 16.4397C18.0783 15.7313 17.0609 15.3333 16 15.3333H8C6.93913 15.3333 5.92172 15.7313 5.17157 16.4397C4.42143 17.1482 4 18.1091 4 19.111V20.9999"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M12 11.5556C14.2091 11.5556 16 9.86419 16 7.77778C16 5.69137 14.2091 4 12 4C9.79086 4 8 5.69137 8 7.77778C8 9.86419 9.79086 11.5556 12 11.5556Z"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                  ...
                  <p className="text-white flex items-center">
                    <span className="mr-2">Upgrade to Plus</span>
                    <span className="bg-[#F7E7A7] text-[#AC760E] text-[9px] px-1 py-0.5 rounded-sm uppercase">
                      New
                    </span>
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5 items-center">
                  ...
                  >
                    <path
                      d="M17.3333 12.889V18.2223C17.3333 18.6938 17.146 19.146 16.8126 19.4794C16.4792 19.8128 16.0271 20.0001 15.5556 20.0001H5.77778C5.30628 20.0001 4.8541 19.8128 4.5207 19.4794C4.1873 19.146 4 18.6938 4 18.2223V8.44453C4 7.97303 4.1873 7.52085 4.5207 7.18745C4.8541 6.85405 5.30628 6.66675 5.77778 6.66675H11.1111"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex gap-5 items-center">
                  ...
                  >
                    <path
                      d="M9.33333 20H5.77778C5.30628 20 4.8541 19.8127 4.5207 19.4793C4.1873 19.1459 4 18.6937 4 18.2222V5.77778C4 5.30628 4.1873 4.8541 4.5207 4.5207C4.8541 4.1873 5.30628 4 5.77778 4H9.33333"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M15.5557 16.4446L20.0001 12.0001L15.5557 7.55566"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
        ...
        <div className="relative container mt-20">
          ...
          <h1 className="text-center text-[32px] font-semibold font-poppins">
            AI-Generated Assessment
          </h1>
          <p className="text-center mt-3 text[16px] font-raleway text-[#202123]">
          ...
          <div className="flex  justify-center mt-5 w-full absolute bottom-16">
            <div className="flex flex-col gap-5">
              <button
                className="py-5 px-14 font-semibold rounded-md"
                style={{
                  background: `radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(148,187,233,1) 100%)`,
                }}
              >
              ...
              <button className="py-5 bg-white px-14 font-semibold rounded-md">
                Human-Centric Assessment
              </button>

              <button className="mt-5 py-5 bg-[#FD8403] px-14 font-semibold rounded-md">
                Next
              </button>
            </div>
          </div>
