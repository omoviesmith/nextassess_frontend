  ...
  return (
    <div className="bg-cover h-screen">
      <div className="w-full lg:w-10/12 mx-auto px-4 py-4">
        ...
        <div>
          <div className="flex items-baseline flex-wrap mt-5">
            <div className="w-full lg:w-6/12 p-2">
              <div className="rounded-full bg-[#CBFFFE] text-center p-5 mx-20 text-lg font-poppins">
                <h2>AI-Integrated Assessment</h2>
              </div>
              <div className="flex flex-wrap gap-7 mt-5 bg-white rounded-lg border border-gray-400">
                <div className="w-full xl:w-2/5">
                  <img src="Rectangle 29.png" className="w-full" />
                </div>

                <div className="pl-2 w-full xl:w-2/5">
                  <p className="pt-4 text-2l lg:text-2xl font-poppins font-semibold">
                    Historical Tale: A Tale of Two Cities
                  </p>
                  <p className="font-raleway my-5 text-gray-600 text-sm">
                    In the midst of the turbulent period of the French
                    Revolution, Charles Dickens weaves a mesmerizing tale of
                    love, sacrifice, and redemption in "A Tale of Two Cities".
                    The novel unfolds against the backdrop of unrest and social
                    upheaval, with vivid descriptions of London and Paris during
                    the late 18th century.
                  </p>
                  <div className="flex pb-2 items-center flex-wrap gap-2">
                    <img src="/avatar.png" width={33.16} height={33.16} />
                    <div>
                      <p className="font-semibold">by Richard Smith</p>
              ...
              <div className="py-5">
                <table className="table-auto border">
                  <thead>
                    <tr>
                      <th className="border border-gray-300 bg-white p-4"></th>
                      <th className="border border-gray-300 bg-white p-4">1</th>
                      <th className="border border-gray-300 bg-white p-4">2</th>
                      <th className="border border-gray-300 bg-white p-4">3</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 bg-white p-2 text-gray-900 text-sm">
                        The Shoemaker's Solitude
                      </td>
                      <td className="border border-gray-300 bg-white p-2 text-gray-500 text-sm">
                        The shoemaker toils silently in his garret, immersed in
                        the solitude of his relentless work.
                      </td>
                      <td className="border border-gray-300 bg-white p-2 text-gray-500 text-sm">
                        The shoemaker toils silently in his garret, immersed in
                        the solitude of his relentless work.
                ...
                <div className="flex flex-wrap lg:flex-nowrap justify-between gap-4 mt-5">
                  ...
                  <div className="border bg-white rounded-lg w-60 py-4 justify-center  flex flex-col items-center gap-1">
                    ...
                    >
                      <path
                        d="M0.344238 17.8175V22.3808H4.90749L18.3661 8.92223L13.8028 4.35897L0.344238 17.8175ZM21.895 5.39331C22.3695 4.91873 22.3695 4.15211 21.895 3.67753L19.0475 0.830055C18.5729 0.355476 17.8063 0.355476 17.3317 0.830055L15.1048 3.05692L19.6681 7.62018L21.895 5.39331V5.39331Z"
                        fill="#323232"
                      />
                    </svg>
            ...
            <div className="w-full lg:w-6/12 p-2">
              <div className="rounded-full bg-[#CBFFFE] text-center p-5 mx-20 text-lg font-poppins">
                <h2>Human-Centric Assessment</h2>
              </div>

              <div className=" mt-5 bg-white rounded-lg border border-gray-400">
                <img src="HumanCentricAssessment.png" className="w-full h-37" />
                <div className="px-14 py-1 flex flex-col text-center items-center">
                  <p className="pt-4 text-2l lg:text-2xl font-poppins font-semibold">
                    Historical Tale: A Tale of Two Cities
                  </p>
                  <p className="font-raleway my-5 text-gray-600 text-sm">
...
export default UploadAssessment9;
